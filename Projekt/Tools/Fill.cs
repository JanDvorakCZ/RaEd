...
namespace RoP_RaEd.Tools
{
    class Fill : Tool
    {
        ...
        {
            try{
                FloodFill((Bitmap)manager.ImageEdit, new Point(manager.MouseCoordsInImage.X, manager.MouseCoordsInImage.Y), Color.Black, manager.ColorManager.color.ToDefaultColor());
            }
